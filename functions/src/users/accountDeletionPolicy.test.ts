...
test("account deletion policy covers every cross-document user reference", () => {
  assert.deepEqual(
    ...
    [
      ...
      "DSA decision actors",
      "DSA appeal decision actors",
      "DSA previous decision actors",
      "DSA previous appeal decision actors",
      "feedback DSA decision actors",
      "DSA statement decision actors",
      "feedback reply actors",
      "feedback latest message actors",
