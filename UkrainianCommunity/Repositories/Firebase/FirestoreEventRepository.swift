...
struct FirestoreEventRepository: EventRepository {
    ...
    func createEvent(_ event: Event) async throws {
        ...
        var data: [String: Any] = [
            ...
            "additionalCategories": dto.additionalCategories ?? [],
    ...
    func updateEvent(_ event: Event) async throws {
        ...
        var data: [String: Any] = [
            ...
            "additionalCategories": event.additionalCategories.map(\.rawValue),
    ...
    private func makeEventDTO(
        ...
        return EventDTO(
            ...
            additionalCategories: data["additionalCategories"] as? [String],
