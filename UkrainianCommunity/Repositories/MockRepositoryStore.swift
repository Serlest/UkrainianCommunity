...
actor MockRepositoryStore {
    ...
    func setEventRegistration(id: String, isRegistered: Bool) throws -> EventRegistrationMutationResult {
        ...
        events[index] = Event(
            ...
            mediaMetadata: events[index].mediaMetadata,
            ...
            scheduledAt: events[index].scheduledAt,
    ...
    func updateOrganization(_ item: Organization) throws {
        ...
        organizations[index] = Organization(
            ...
            directoryProfile: item.directoryProfile,
            ...
            pinnedNewsId: item.pinnedNewsId,
            pinnedEventId: item.pinnedEventId,
