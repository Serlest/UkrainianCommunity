...
enum SystemLogDisplayFormatting {
    ...
    nonisolated static func actorRoleTitle(_ role: SystemLogActorRole) -> String {
        ...
        case .retiredGuideEditor: localized("role.guide_editor", "Редактор довідника")
    ...
    nonisolated static func targetTypeTitle(_ targetType: SystemLogTargetType) -> String {
        ...
        case .retiredGuideArticle: localized("target.guide_article", "Матеріал довідника")
        case .retiredGuideMaterial: localized("target.guide_material", "Матеріал довідника")
