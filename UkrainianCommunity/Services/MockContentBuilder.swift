    ...
    nonisolated static func marketplaceItems() -> [MarketplaceItem] {
        [
            MarketplaceItem(
                ...
                price: nil,
                isFreeGift: true,
                expirationDate: calendar.date(byAdding: .day, value: 12, to: .now) ?? .now,
                sellerName: localized("mock.market.1.seller", "Mariia"),
                createdAt: calendar.date(byAdding: .day, value: -1, to: .now) ?? .now,
                updatedAt: calendar.date(byAdding: .hour, value: -6, to: .now) ?? .now,
                contactValue: "@mariia_help",
            ...
            MarketplaceItem(
                ...
                price: 45,
                isFreeGift: false,
                expirationDate: calendar.date(byAdding: .day, value: 7, to: .now) ?? .now,
                sellerName: localized("mock.market.2.seller", "Andrii"),
                createdAt: calendar.date(byAdding: .day, value: -4, to: .now) ?? .now,
                updatedAt: calendar.date(byAdding: .day, value: -1, to: .now) ?? .now,
                contactValue: "andrii@example.com",
                contactMethod: .email,
                comments: [],
                moderationStatus: .pendingReview,
                likeCount: 6,
